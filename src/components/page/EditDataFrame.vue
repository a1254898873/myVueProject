...
export default {
  ...
  methods: {
    ...
    getDataFrame: function() {
      getRequest("/dataframe?id=" + this.dataId).then(resp => {
        var data = resp.data;
        var datainfo = data.obj;
        this.infoForm.id = datainfo.id;
        this.infoForm.projectName = datainfo.projectName;
        this.infoForm.fileUrl = datainfo.fileUrl;
        this.infoForm.overview = datainfo.overview;
        this.infoForm.state = datainfo.state;
        this.infoForm.licence = datainfo.licence;
    ...
    onSubmit() {
      ...
      this.$refs.infoForm.validate(valid => {
        if (valid) {
          postRequest("dataframe/update", this.infoForm).then(resp => {
